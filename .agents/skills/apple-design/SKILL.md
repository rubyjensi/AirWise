...
name: apple-design
description: >-
  Apple design system specifications, design tokens, typography rules, color palettes,
  and component guidelines. Use this skill when designing or implementing user interfaces,
  web or mobile layouts (such as VayuGuard PWA), photography-first surfaces, SF Pro typography
  with tight letter-spacing, monochromatic canvas tiers, and minimalist Apple aesthetics.
version: alpha
